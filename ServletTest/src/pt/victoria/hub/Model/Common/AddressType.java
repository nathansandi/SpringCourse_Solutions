...
public class AddressType implements java.io.Serializable {
    ...
    public static final java.lang.String _FISCAL = "FISCAL";
    public static final AddressType FISCAL = new AddressType(_FISCAL);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hub.victoria.pt/Model/Common/", "AddressType"));
    }
    /**
