...
public class ContactType implements java.io.Serializable {
    ...
    public static final ContactType PHONE = new ContactType(_PHONE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hub.victoria.pt/Model/Client/", "ContactType"));
    }
    /**
