...
public class ClientType implements java.io.Serializable {
    ...
    public static final ClientType INDIVIDUAL = new ClientType(_INDIVIDUAL);
    public static final ClientType CORPORATE = new ClientType(_CORPORATE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://hub.victoria.pt/Model/Client/", "ClientType"));
    }
    /**
