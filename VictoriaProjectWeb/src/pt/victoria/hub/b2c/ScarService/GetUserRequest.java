...
public class GetUserRequest  extends pt.victoria.hub.b2c.ws.common.AbstractWebRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the user value for this GetUserRequest.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this GetUserRequest.
     * 
     * @param user
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://b2c.hub.victoria.pt/ScarService/", ">GetUserRequest"));
