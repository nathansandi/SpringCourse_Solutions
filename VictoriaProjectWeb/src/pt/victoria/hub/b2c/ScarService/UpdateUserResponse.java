...
public class UpdateUserResponse  extends pt.victoria.hub.b2c.ws.common.AbstractWebResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the user value for this UpdateUserResponse.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this UpdateUserResponse.
     * 
     * @param user
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://b2c.hub.victoria.pt/ScarService/", ">UpdateUserResponse"));
