...
public class CreateUserResponse  extends pt.victoria.hub.b2c.ws.common.AbstractWebResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the user value for this CreateUserResponse.
     * 
     * @return user
     */
    ...
    /**
     * Sets the user value for this CreateUserResponse.
     * 
     * @param user
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://b2c.hub.victoria.pt/ScarService/", ">CreateUserResponse"));
